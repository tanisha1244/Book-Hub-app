...
import com.example.book.activity.Description
import com.example.book.model.Book
import com.squareup.picasso.Picasso

class DashbordRecyclerAdapter(val context: Context, val itemList: ArrayList<Book>) :
    RecyclerView.Adapter<DashbordRecyclerAdapter.DashboardViewHolder>() {
